...
export const SimpleRuler = ({ 
  ...
  return (
    <div className="sticky top-[108px] z-40 bg-white border-b border-gray-300">
      <div 
        ref={rulerRef}
        className="relative h-[30px] mx-auto select-none"
      ...
      >
        ...
        {/* Triángulo IZQUIERDO (margin-left) */}
        <div
        ...
        >
          <svg width="12" height="14" viewBox="0 0 12 14">
            <polygon 
              ...
              fill={isDragging === 'left' ? '#2563eb' : '#3b82f6'}
              className="drop-shadow-sm"
            />
          </svg>
        </div>
        
        {/* Triángulo DERECHO (margin-right) */}
        <div
          className={`absolute top-[16px] cursor-ew-resize transition-transform ${
        ...
        >
          <svg width="12" height="14" viewBox="0 0 12 14">
            <polygon 
              points="6,0 12,14 0,14" 
              fill={isDragging === 'right' ? '#2563eb' : '#3b82f6'}
              className="drop-shadow-sm"
            />
          </svg>
        </div>
        ...
        {isDragging && (
          <>
            {isDragging === 'left' && (
              <div
                className="absolute top-[30px] w-[2px] bg-blue-500 opacity-50 pointer-events-none"
                style={{ 
                  left: leftMargin,
