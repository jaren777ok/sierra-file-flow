...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 to-stone-100">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold text-sierra-teal mb-2">
                Procesamiento Inteligente por Áreas
              </h3>
              <p className="text-sierra-gray max-w-3xl mx-auto">
                Ingresa el nombre del proyecto, selecciona el área correspondiente y sube exactamente 2 archivos para cada una. 
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center px-4 py-2 bg-sierra-teal/10 rounded-full">
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse mr-2"></div>
              <span className="text-sm text-sierra-teal font-medium">
      ...
      <footer className="sierra-gradient text-white py-6 mt-16">
